...
========================================================== */
const CACHE_NAME = "air-tahiti-tools-v3";
const APP_SHELL = [
    "./","./index.html","./manifest.json",
    "./css/variables.css?v=3","./css/themes.css?v=3","./css/components.css?v=3","./css/home.css?v=3",
    "./css/fuel.css","./css/torque.css","./css/settings.css",
    "./js/app.js?v=3","./js/home.js?v=3","./js/fuel.js","./js/torque.js","./js/settings.js",
