...
const APP_SHELL = [
    ...
    "./css/variables.css?v=6","./css/themes.css?v=6","./css/components.css?v=6","./css/home.css?v=6","./css/alpha-callup.css","./css/outillage-magasin.css",
    "./css/fuel.css","./css/torque.css","./css/settings.css",
    "./js/app.js?v=6","./js/home.js?v=6","./js/fuel.js","./js/torque.js","./js/settings.js",
